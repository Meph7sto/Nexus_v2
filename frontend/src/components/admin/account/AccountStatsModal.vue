    ...
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-emerald-200 bg-emerald-50 p-4   "
          >
          ...
          <div
            class="card border-blue-200 bg-blue-50 p-4   "
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-gray-500 ">{{
          ...
          <!-- Daily Average Cost -->
          <div
            class="card border-amber-200 bg-amber-50 p-4   "
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-gray-500 ">{{
          ...
          <div
            class="card border-purple-200 bg-purple-50 p-4   "
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-gray-500 ">{{
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-blue-100 p-1.5 ">
                <Icon name="clock" size="sm" class="text-blue-600 " />
              </div>
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 ">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 "
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 ">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 "
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-orange-100 p-1.5 ">
                <Icon name="fire" size="sm" class="text-orange-600 " />
              </div>
              <span class="text-sm font-semibold text-gray-900 ">{{
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-primary-100 p-1.5 ">
                <Icon name="cube" size="sm" class="text-primary-600 " />
              </div>
              <span class="text-sm font-semibold text-gray-900 ">{{
