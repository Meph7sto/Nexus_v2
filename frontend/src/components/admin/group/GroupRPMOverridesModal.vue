  ...
  <BaseDialog :show="show" :title="t('admin.groups.rpmOverridesTitle')" width="wide" @close="handleClose">
    <div v-if="group" class="space-y-4">
      ...
      <div class="rounded-lg border border-gray-200 p-3 ">
        ...
        <div v-if="localEntries.length > 0" class="mt-3 flex items-center justify-end border-t border-gray-100 pt-3 ">
          <button
            type="button"
            :disabled="clearing"
              ...
              <table class="w-full text-sm">
                <thead class="sticky top-0 z-[1]">
                  <tr class="border-b border-gray-200 bg-gray-50  ">
                    ...
                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 " :title="t('admin.groups.columns.rpmOverrideHint')">{{ t('admin.groups.columns.rpmOverride') }}</th>
