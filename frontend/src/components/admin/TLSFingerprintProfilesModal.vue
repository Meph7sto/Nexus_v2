<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-else class="max-h-96 overflow-auto rounded-lg border border-gray-200 ">
        <table class="min-w-full divide-y divide-gray-200 ">
          ...
          <tbody class="divide-y divide-gray-200 bg-white  ">
            <tr v-for="profile in profiles" :key="profile.id" class="hover:bg-gray-50 ">
              ...
              <td class="px-3 py-2">
                <div v-if="profile.description" class="text-sm text-gray-500  max-w-xs truncate">
                  {{ profile.description }}
                </div>
        ...
        <div>
          ...
          <div class="mt-1 flex items-center gap-2">
            ...
            <p class="text-xs text-gray-500 ">
              ...
              <a href="https://tls.sub2api.org" target="_blank" rel="noopener noreferrer" class="text-primary-600 hover:text-primary-700   underline">{{ t('admin.tlsFingerprintProfiles.form.openCollector') }}</a>
            </p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-3">
          <button
            ...
            :class="[
              ...
              form.enable_grease ? 'bg-primary-600' : 'bg-gray-200 '
            ]"
          >
            <span
              :class="[
