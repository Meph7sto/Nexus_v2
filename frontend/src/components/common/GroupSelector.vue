<template>
  <div>
    ...
    <div
      v-if="isSearchable"
      class="flex items-center gap-2 rounded-t-lg border border-b-0 border-gray-200 bg-gray-50 px-3 py-2  "
    >
    ...
    <div
      :class="[
        ...
        isSearchable
          ? 'rounded-b-lg border border-t-0 border-gray-200 bg-gray-50  '
    ...
    >
      <label
        ...
        :key="group.id"
        class="flex cursor-pointer items-center gap-2 rounded px-2 py-1.5 transition-colors hover:bg-white "
      ...
      >
        <input
          ...
          class="h-3.5 w-3.5 shrink-0 rounded border-gray-300 text-primary-500 focus:ring-primary-500 "
        />
        <GroupBadge
          :name="group.name"
