  ...
  >
    ...
    >
      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        ...
        <div v-if="account.platform !== 'antigravity'" class="border-t border-gray-200 pt-4 ">
      ...
      <div v-if="headerOverrideCapable" class="border-t border-gray-200 pt-4 ">
        <div class="mb-3 flex items-center justify-between">
          <div>
        ...
        <div>
          ...
          <div class="mb-3 flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg border border-emerald-200 px-3 py-1.5 text-sm text-emerald-600 hover:bg-emerald-50 disabled:cursor-not-allowed disabled:opacity-60   "
            >
      ...
      >
        <div class="overflow-hidden rounded-lg border border-sky-100 bg-sky-50/60 shadow-sm  ">
          <div class="flex items-start gap-3 px-4 py-3">
            <div class="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-white text-sky-600 shadow-sm ring-1 ring-sky-100   ">
          ...
          <div class="border-t border-sky-100 bg-white/70 p-2  ">
              ...
              <button
                ...
                :class="[
                  ...
                  codexImageToolMode === option.value
                    ...
                    : 'border-transparent bg-transparent text-slate-600 hover:border-gray-200 hover:bg-gray-50   '
                ]"
              >
                <span
                  :class="[
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause5hDisabled ? 'bg-primary-600' : 'bg-gray-200 '
              ]"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause7dDisabled ? 'bg-primary-600' : 'bg-gray-200 '
              ]"
        ...
        <div v-if="account?.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-not-allowed items-center gap-2 opacity-60">
            <input
              ...
              disabled
              class="h-4 w-4 cursor-not-allowed rounded border-gray-300 text-primary-500 focus:ring-primary-500 "
            />
...
const codexImageToolOptions = computed<Array<{
  ...
  },
  {
    ...
    selectedCardClass: 'border-emerald-300 bg-emerald-50 text-emerald-900 shadow-sm ring-1 ring-emerald-200    ',
  ...
  },
  {
    ...
    selectedCardClass: 'border-amber-300 bg-amber-50 text-amber-900 shadow-sm ring-1 ring-amber-200    ',
