  ...
  <div class="space-y-4">
    ...
    <template v-else-if="success">
      <div class="card p-6">
        <div class="flex flex-col items-center space-y-4 py-4">
          ...
          <div class="w-full rounded-lg bg-gray-50 p-4 ">
            <div class="space-y-2 text-sm">
              ...
              <div v-if="amount > 0" class="flex justify-between">
                ...
                <span class="font-medium text-gray-900 ">{{ creditedAmountSymbol }}{{ amount.toFixed(2) }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-500 ">{{ t('payment.orders.payAmount') }}</span>
                <span class="font-medium text-gray-900 ">{{ paymentAmountSymbol }}{{ payAmount.toFixed(2) }}</span>
              </div>
            </div>
          </div>
    ...
    <template v-else>
      ...
      <div class="card overflow-hidden">
        <div class="bg-[#635bff] px-6 py-5 text-center">
