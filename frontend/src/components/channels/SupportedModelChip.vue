  ...
  <div class="relative inline-block">
    ...
    >
      ...
      <span
        ...
        class="rounded bg-gray-200/60 px-1 text-[10px] uppercase text-gray-600  "
      >
        {{ model.platform }}
      </span>
      {{ model.name }}
    ...
    <Teleport to="body">
      <div
        ...
        ref="popoverEl"
        role="tooltip"
        class="pointer-events-none fixed z-[99999] w-80 max-w-[min(22rem,calc(100vw-1rem))] rounded-lg border bg-white text-xs shadow-card "
      ...
      >
        ...
        >
          ...
          <span
            v-if="model.platform"
            class="flex-shrink-0 rounded bg-white/70 px-1.5 py-0.5 text-[10px] uppercase tracking-wide "
          >
            {{ model.platform }}
          </span>
        </div>
        ...
        <div class="p-3">
          <div v-if="!model.pricing" class="text-gray-500 ">
            {{ noPricingLabel }}
          </div>

          <div v-else class="space-y-2 text-gray-700 ">
            <div class="flex justify-between">
              <span class="text-gray-500 ">{{ t(prefixKey('billingMode')) }}</span>
            ...
            <div
              ...
              :class="[popoverBorderClass]"
            >
              <div class="mb-1 font-medium text-gray-600 ">
