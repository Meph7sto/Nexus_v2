  ...
  <div class="card">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        <div v-for="log in data" :key="log.id" class="flex items-center justify-between rounded-lg bg-gray-50 p-4 transition-colors hover:bg-gray-100  ">
          ...
          <div class="text-right">
            <p class="text-sm font-semibold">
              <span class="text-green-600 " :title="t('dashboard.actual')">${{ formatCost(log.actual_cost) }}</span>
