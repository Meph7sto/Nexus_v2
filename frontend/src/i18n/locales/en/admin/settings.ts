export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Nexus end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Nexus end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream Nexus sites connected to OpenAI API keys.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on Nexus orders; the upstream type is sent as EasyPay type.',
      ...
      usageInteractions: {
        ...
        recordingEnabledHint: 'When enabled, each new usage record stores input and output details.',
        storeRawEnabled: 'Store raw JSON',
        storeRawEnabledHint: 'Raw request and response JSON is redacted before storage and requires step-up verification to view.',
        retentionDays: 'Interaction retention days',
        retentionDaysHint: '0 keeps details indefinitely. Maximum: 3650 days.'
      },
      user_error_view: {
