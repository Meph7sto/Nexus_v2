...
<template>
  <div class="space-y-6">
    ...
    <div :class="['rounded-lg bg-white shadow-sm ring-1 ring-gray-900/5  ', props.fullscreen ? 'p-8' : 'p-6']">
      <div class="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 pb-4 ">
        ...
        <div v-if="!props.fullscreen" class="flex flex-wrap items-center gap-3">
          ...
          <div class="h-9 w-[160px] animate-pulse rounded-lg bg-gray-200 "></div>
          <div class="h-9 w-[150px] animate-pulse rounded-lg bg-gray-200 "></div>
          <div class="h-9 w-9 animate-pulse rounded-lg bg-gray-200 "></div>
          <div class="h-9 w-28 animate-pulse rounded-lg bg-gray-200 "></div>
          <div class="h-9 w-28 animate-pulse rounded-lg bg-gray-200 "></div>
          <div class="h-9 w-9 animate-pulse rounded-lg bg-gray-200 "></div>
        </div>
      </div>
      ...
      <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div class="rounded-lg bg-gray-50 p-4  lg:col-span-5">
        ...
        <div class="lg:col-span-7">
          <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="i in 6" :key="i" class="h-20 animate-pulse rounded-lg bg-gray-50 "></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
      <div :class="['min-h-[360px] rounded-lg bg-white shadow-sm ring-1 ring-gray-900/5   lg:col-span-1', props.fullscreen ? 'p-8' : 'p-6']">
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 "></div>
        <div class="mt-6 h-72 animate-pulse rounded-lg bg-gray-100 "></div>
      </div>
      <div :class="['min-h-[360px] rounded-lg bg-white shadow-sm ring-1 ring-gray-900/5   lg:col-span-1', props.fullscreen ? 'p-8' : 'p-6']">
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 "></div>
        <div class="mt-6 h-72 animate-pulse rounded-lg bg-gray-100 "></div>
      </div>
      <div :class="['min-h-[360px] rounded-lg bg-white shadow-sm ring-1 ring-gray-900/5   lg:col-span-2', props.fullscreen ? 'p-8' : 'p-6']">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      <div
        v-for="i in 3"
        :key="i"
        :class="['rounded-lg bg-white shadow-sm ring-1 ring-gray-900/5  ', props.fullscreen ? 'p-8' : 'p-6']"
      >
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 "></div>
        <div class="mt-6 h-56 animate-pulse rounded-lg bg-gray-100 "></div>
      </div>
    </div>
    ...
    <div :class="['rounded-lg bg-white shadow-sm ring-1 ring-gray-900/5  ', props.fullscreen ? 'p-8' : 'p-6']">
      <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div v-if="!props.fullscreen" class="flex flex-wrap items-center gap-2">
          <div class="h-9 w-[140px] animate-pulse rounded-lg bg-gray-200 "></div>
          <div class="h-9 w-[120px] animate-pulse rounded-lg bg-gray-200 "></div>
          <div class="h-9 w-[120px] animate-pulse rounded-lg bg-gray-200 "></div>
        </div>
      </div>
