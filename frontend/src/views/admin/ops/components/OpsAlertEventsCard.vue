...
function severityBadgeClass(severity: string | undefined): string {
  ...
  if (s === 'p2' || s === 'info') return 'bg-blue-100 text-blue-700  '
  if (s === 'p3') return 'bg-gray-100 text-gray-700  '
...
<template>
  <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-900/5  ">
    ...
    <div v-else-if="empty" class="rounded-lg border border-dashed border-gray-200 p-8 text-center text-sm text-gray-500  ">
        ...
        <div class="rounded-lg bg-gray-50 p-4 ">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
              <div class="flex items-center gap-2 rounded-lg bg-white px-2 py-1 ring-1 ring-gray-200  ">
                ...
                />
                <AdminPermissionGate resource="alert_silences" action="create">
              ...
              <AdminPermissionGate resource="alert_events" action="update">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-lg bg-gray-50 p-4 ">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                <a
                  class="inline-flex items-center gap-1 rounded-md bg-white px-2 py-1 text-[11px] font-bold text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50    "
