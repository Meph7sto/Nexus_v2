          ...
          <div class="flex flex-1 flex-wrap items-center gap-3">
            ...
            >
              ...
              <div
                ...
                class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-gray-200 bg-white shadow-card  "
              >
                <div
          ...
          <div class="ml-auto flex flex-wrap items-center justify-end gap-3">
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-lg border border-gray-200 bg-white shadow-card  "
              >
                <div class="p-2">
            ...
            <AdminPermissionGate resource="subscriptions" action="create">
        ...
        >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <AdminPermissionGate resource="subscriptions" action="execute">
                <button
              ...
              <AdminPermissionGate resource="subscriptions" action="execute">
                <button
                  ...
                  class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-orange-50 hover:text-orange-600   disabled:cursor-not-allowed disabled:opacity-50"
                >
    ...
    <AdminPermissionGate resource="subscriptions" action="execute">
      ...
      >
        <div class="rounded-lg bg-gray-50 p-4 ">
          ...
          <p v-if="extendingSubscription.expires_at" class="mt-1 text-sm text-gray-600 ">
    ...
    <teleport to="body">
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          ...
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6 shadow-card ">
            <button type="button" class="absolute right-4 top-4 text-gray-400 hover:text-gray-600 " @click="showGuideModal = false">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
            </button>

            <h2 class="mb-4 text-lg font-bold text-gray-900 ">{{ t('admin.subscriptions.guide.title') }}</h2>
            <p class="mb-5 text-sm text-gray-500 ">{{ t('admin.subscriptions.guide.subtitle') }}</p>
            ...
            <div class="mb-5">
              ...
              <div class="ml-8 overflow-hidden rounded-lg border border-gray-200 ">
                <table class="w-full text-sm">
                  <tbody>
                    <tr v-for="(row, i) in guideActionRows" :key="i" class="border-b border-gray-100  last:border-0">
                      <td class="whitespace-nowrap bg-gray-50 px-3 py-2 font-medium text-gray-700  ">{{ row.action }}</td>
                      <td class="px-3 py-2 text-gray-600 ">{{ row.desc }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
.usage-label {
  @apply w-10 flex-shrink-0 text-xs font-medium text-gray-500 ;
}

.usage-amount {
  @apply whitespace-nowrap text-xs tabular-nums text-gray-600 ;
}

.reset-info {
  @apply flex items-center gap-1 pl-12 text-[10px] text-blue-600 ;
}
</style>
