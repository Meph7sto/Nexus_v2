    ...
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
              ...
              <div v-else class="space-y-4">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <code
                      class="rounded bg-gray-100 px-2 py-1 font-mono text-sm text-gray-900  "
                    >
                      {{ adminApiKeyMasked }}
                    </code>
                  </div>
                  <div class="flex gap-2">
                    ...
                    <AdminPermissionGate resource="settings" action="delete">
                      <button
                        type="button"
                ...
                >
                  ...
                  <div class="flex items-center gap-2">
                    <code
                      class="flex-1 select-all break-all rounded border border-green-300 bg-white px-3 py-2 font-mono text-sm  "
                    >
                      {{ newAdminApiKey }}
                    </code>
                    <button
              ...
              <template v-else>
                ...
                >
                  ...
                  <div
                    ...
                    class="ml-4 space-y-3 border-l-2 border-gray-200 pl-4 "
                  >
                    <div>
                      <label
                        class="text-sm font-medium text-gray-700 "
                ...
                >
                  ...
                  <div v-if="betaPresets[rule.beta_token]?.length" class="mt-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <button
                        ...
                        :key="preset.label"
                        type="button"
                        class="inline-flex items-center gap-1 rounded-md border border-primary-200 bg-primary-50 px-2.5 py-1 text-xs font-medium text-primary-700 transition-colors hover:bg-primary-100    "
                  ...
                  <div class="mt-3">
                    ...
                    <button
                      ...
                      "
                      class="mb-2 inline-flex items-center gap-1 text-xs text-primary-600 transition-colors hover:text-primary-700  "
                    >
                      <svg
                        class="h-3.5 w-3.5"
                        fill="none"
                    ...
                    <div class="flex flex-wrap items-center gap-1.5">
                      ...
                      <button
                        ...
                        :key="pattern"
                        type="button"
                        class="rounded border border-gray-200 px-2 py-0.5 text-xs text-gray-600 transition-colors hover:border-primary-300 hover:bg-primary-50 hover:text-primary-700     "
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <div class="border-t border-gray-100 pt-4 ">
                ...
                <div
                  class="mt-3 rounded-lg border border-gray-300 bg-white p-2  "
                >
                  <div class="flex flex-wrap items-center gap-2">
                    <span
                      v-for="suffix in registrationEmailSuffixWhitelistTags"
                      :key="suffix"
                      class="inline-flex items-center gap-1 rounded bg-gray-100 px-2 py-1 text-xs font-mono text-gray-700  "
                    >
                      <span>{{ suffix }}</span>
                      <button
                        type="button"
                        class="rounded-full text-gray-500 hover:bg-gray-200 hover:text-gray-700   "
                        @click="
                    ...
                    >
                      <input
                        ...
                        type="text"
                        class="w-full bg-transparent text-sm font-mono text-gray-900 outline-none placeholder:text-gray-400  "
                        :placeholder="
                          t(
                  ...
                  <div>
                    ...
                    >
                      ...
                      <code
                        ...
                        class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600  "
                      >
                ...
                <div class="rounded-lg border border-gray-200 p-4 ">
                  ...
                  <div v-if="form.github_oauth_enabled" class="mt-4 space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                      <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700 ">Client ID</label>
                        <input
                      ...
                      <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700 ">Client Secret</label>
                        <input
            ...
            <div class="space-y-5 p-6">
              ...
              >
                <div class="grid grid-cols-1 gap-6">
                  ...
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                    class="pt-4 border-t border-gray-100  space-y-2"
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        <label class="font-medium text-gray-900 ">{{
                    ...
                    <div v-if="form.dingtalk_connect_sync_display_name" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600  whitespace-nowrap min-w-[5rem]">
                    ...
                    <p v-if="form.dingtalk_connect_sync_display_name" class="text-xs text-gray-400 ">
                  ...
                  >
                    ...
                    <p v-if="form.dingtalk_connect_sync_corp_email" class="text-xs text-gray-400 ">
                  ...
                  >
                    ...
                    <p v-if="form.dingtalk_connect_sync_dept" class="text-xs text-gray-400 ">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              >
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div
                    class="flex items-center justify-between rounded border border-gray-200 px-4 py-3 "
                  >
                    <div>
                      <label class="font-medium text-gray-900 ">
            ...
            <div class="space-y-6 p-6">
              ...
              <div class="border-t border-gray-100 pt-4 ">
                ...
                <div
                  ...
                  class="rounded border border-dashed border-gray-300 px-4 py-3 text-sm text-gray-500  "
                >
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="grid grid-cols-1 gap-3 rounded border border-gray-200 p-3 md:grid-cols-[1fr_160px_auto] "
                  >
                    <div>
                      <label
                        class="mb-1 block text-xs font-medium text-gray-600 "
                    ...
                    <div class="flex items-end">
                      <button
                        type="button"
                        class="btn btn-secondary default-sub-delete-btn w-full text-red-600 hover:text-red-700 "
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <button
                      type="button"
                      class="btn btn-secondary btn-sm shrink-0 text-red-600 hover:text-red-700 "
                ...
                <div>
                  ...
                  >
                    ...
                    />
                    <label
                      class="flex shrink-0 items-center gap-1 text-xs text-gray-600 "
                      :title="
                        t(
            ...
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                ...
                <div
                  class="flex justify-end border-t border-gray-100 pt-4 "
                >
                  <AdminPermissionGate resource="accounts" action="update">
                    <button
                      type="button"
                      class="btn btn-primary btn-sm"
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <div
                ...
                class="flex flex-col items-stretch gap-3 border-t border-gray-100 pt-5 sm:flex-row sm:items-start sm:justify-between sm:gap-6 "
              >
                <div class="min-w-0">
                  <label
                    class="text-sm font-medium text-gray-700 "
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <button
                          type="button"
                          class="btn btn-secondary btn-sm px-2 text-red-600 hover:text-red-700 "
            ...
            <div class="space-y-5 p-6">
              ...
              <div v-if="webSearchConfig.enabled" class="space-y-4">
                ...
                <div
                  ...
                  class="rounded-lg border border-dashed border-gray-300 p-4 text-center text-sm text-gray-400 "
                >
                ...
                >
                  ...
                  <div
                    ...
                    class="space-y-3 border-t border-gray-100 px-4 pb-4 pt-3 "
                  >
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <div
                        v-if="
                          ...
                          provider.quota_limit > 0
                        "
                        class="flex-1 rounded-full bg-gray-200 "
                        style="height: 6px"
                      >
                        <div
          ...
          >
            <div
              class="mx-4 w-full max-w-lg rounded-lg bg-white p-6 shadow-card "
            >
              <h3
              ...
              <div
                v-if="wsTestResult"
                class="mt-4 max-h-80 overflow-y-auto rounded-lg bg-gray-50 p-4 "
              >
                <p
                ...
                <div
                  ...
                  :key="rIdx"
                  class="mt-2 border-t border-gray-200 pt-2 first:mt-0 first:border-0 first:pt-0 "
                >
                  <a
                    :href="r.url"
                    target="_blank"
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              <div>
                ...
                <button
                  type="button"
                  class="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border-2 border-dashed border-gray-300 px-4 py-2.5 text-sm text-gray-500 transition-colors hover:border-primary-400 hover:text-primary-600    "
                  @click="addEndpoint"
                >
                  <svg
                    class="h-4 w-4"
          ...
          <div class="card">
            ...
            <div class="space-y-4 p-6">
              ...
              <button
                type="button"
                class="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-dashed border-gray-300 py-3 text-sm text-gray-500 transition-colors hover:border-primary-400 hover:text-primary-600    "
                @click="addMenuItem"
              >
                <svg
                  class="h-4 w-4"
                  ...
                  >
                    <div class="mb-3 flex items-center justify-between gap-3">
                      <div class="flex min-w-0 items-center gap-3">
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md bg-gray-100 text-gray-700  ">
                          <Icon
                            :name="
                              index === 1
                                ? 'shield'
                      ...
                      <button
                        type="button"
                        class="rounded-md p-2 text-red-400 transition hover:bg-red-50 hover:text-red-600 disabled:cursor-not-allowed disabled:opacity-40 "
                        :disabled="
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                      ...
                      <div>
                        ...
                        <div class="flex overflow-hidden rounded-lg border border-gray-300 bg-white focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500  ">
                          <span class="inline-flex flex-shrink-0 items-center border-r border-gray-200 bg-gray-50 px-3 text-sm text-gray-500   ">
                            /legal/
                          </span>
                          <input
                            v-model="doc.id"
                            type="text"
                            class="min-w-0 flex-1 border-0 bg-transparent px-3 py-2 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:ring-0  "
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              ...
              <div class="border-t border-gray-100 pt-6 ">
                <div class="mb-3 flex items-center justify-between">
                  ...
                  <AdminPermissionGate resource="affiliates" action="update">
                    <button
                      type="button"
                      class="btn btn-primary btn-sm"
                ...
                <div class="mb-3 flex items-center gap-2">
                  ...
                  />
                  <AdminPermissionGate v-if="affiliateState.selected.length > 0" resource="affiliates" action="update">
                    <button
                      type="button"
                      class="btn btn-secondary btn-sm"
                  ...
                  <table class="min-w-full divide-y divide-gray-200 ">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white  ">
                      ...
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        ...
                        <td class="px-3 py-2 text-sm text-gray-900 ">{{ entry.email }}</td>
                        <td class="px-3 py-2 text-sm text-gray-600 ">{{ entry.username }}</td>
                        <td class="px-3 py-2 text-sm font-mono">
                          {{ entry.aff_code }}
                          <span
                            v-if="entry.aff_code_custom"
                            class="ml-1 inline-block rounded bg-primary-100 px-1.5 py-0.5 text-[10px] font-medium text-primary-700  "
                        ...
                        <td class="px-3 py-2 text-sm">
                          <div class="flex items-center gap-2">
                            ...
                            <AdminPermissionGate resource="affiliates" action="delete">
                              <button
                                type="button"
        ...
        >
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-card ">
            ...
            <div class="space-y-4">
              <div v-if="affiliateModal.mode === 'add'">
                ...
                <div
                  ...
                  class="flex items-center justify-between rounded-md border border-primary-200 bg-primary-50 px-3 py-2  "
                >
                  <div class="text-sm">
                    <span class="font-medium text-gray-900 ">{{ affiliateModal.selectedUser.email }}</span>
                ...
                <template v-else>
                  ...
                  <div
                    ...
                    class="mt-1 max-h-40 overflow-y-auto rounded border border-gray-200 "
                  >
                    <button
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "Nexus") +
                        " 100 " +
      ...
      <AdminPermissionGate resource="payment_providers" :action="editingProvider ? 'update' : 'create'">
      ...
      <AdminPermissionGate resource="payment_providers" action="delete">
        <ConfirmDialog
...
async function saveWebSearchConfig(): Promise<boolean> {
  if (!authStore.canAdmin("settings", "update")) return false;
  try {
...
async function deleteAdminApiKey() {
  if (!authStore.canAdmin("settings", "delete")) return;
...
async function saveUpstreamBillingProbeSettings() {
  if (!authStore.canAdmin("accounts", "update")) return;
...
async function disableProvidersByType(type: string) {
  if (!authStore.canAdmin("payment_providers", "update")) return;
...
function openCreateProvider() {
  if (!authStore.canAdmin("payment_providers", "create")) return;
...
async function handleSaveProvider(payload: Partial<ProviderInstance>) {
  if (!authStore.canAdmin("payment_providers", editingProvider.value ? "update" : "create")) return;
...
function confirmDeleteProvider(provider: ProviderInstance) {
  if (!authStore.canAdmin("payment_providers", "delete")) return;
...
function openAffiliateConfirm(
  ...
  if (!authStore.canAdmin("affiliates", "delete")) return;
...
function openAffiliateModal(entry: AffiliateAdminEntry | null) {
  if (!authStore.canAdmin("affiliates", "update")) return;
...
.settings-tab {
  @apply relative isolate flex h-10 min-w-[6.75rem] shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-lg border border-transparent px-3 text-sm font-medium text-gray-600 outline-none transition-colors duration-200 ease-out ;
}
...
.settings-tab:focus-visible {
  @apply ring-2 ring-primary-500/40 ring-offset-2 ring-offset-white ;
}

.settings-tab-active {
  @apply border-primary-200/80 bg-white text-primary-700 shadow-sm   ;
  box-shadow:
...
.settings-tab-icon {
  @apply flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-gray-500 transition-colors duration-200 ;
}
