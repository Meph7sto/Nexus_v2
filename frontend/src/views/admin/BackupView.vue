    ...
    <div class="space-y-6">
      ...
      <div class="card p-6">
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500 ">
              ...
              <button type="button" class="text-primary-600 underline hover:text-primary-700  " @click="showR2Guide = true">Cloudflare R2</button>
        ...
        <div class="mt-4 flex flex-wrap gap-2">
          <AdminPermissionGate resource="backups" action="execute">
      ...
      <div class="card p-6">
        ...
        <div class="overflow-x-auto">
          <table class="w-full min-w-[800px] text-sm">
            ...
            <tbody>
              <tr v-for="record in backups" :key="record.id" class="border-b border-gray-100 align-top ">
                ...
                <td class="py-3 text-xs">
                  <div class="flex flex-wrap gap-1">
                    <AdminPermissionGate resource="backups" action="export">
                      <button
                    ...
                    <AdminPermissionGate resource="backups" action="delete">
                      <button
                        type="button"
        ...
        <div v-if="showR2Guide" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showR2Guide = false">
          ...
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6 shadow-card ">
            ...
            <div class="mb-5">
              ...
              <code class="ml-8 mt-1 block rounded bg-gray-100 px-3 py-2 text-xs text-gray-800  ">https://&lt;{{ t('admin.backup.r2Guide.step3.accountId') }}&gt;.r2.cloudflarestorage.com</code>
            </div>
            ...
            <div class="mb-5">
              ...
              <div class="ml-8 overflow-hidden rounded-lg border border-gray-200 ">
                <table class="w-full text-sm">
                  <tbody>
                    <tr v-for="(row, i) in r2ConfigRows" :key="i" class="border-b border-gray-100  last:border-0">
                      <td class="whitespace-nowrap bg-gray-50 px-3 py-2 font-medium text-gray-700  ">{{ row.field }}</td>
...
async function testS3() {
  if (!authStore.canAdmin('backups', 'execute')) return
...
async function downloadBackup(id: string) {
  if (!authStore.canAdmin('backups', 'export')) return
  try {
