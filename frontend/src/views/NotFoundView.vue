    ...
    <div class="relative z-10 w-full max-w-md text-center">
      ...
      <div class="mb-8">
        <div class="relative inline-block">
          <span class="text-[12rem] font-bold leading-none text-gray-100 "
            >404</span
          >
          <div class="absolute inset-0 flex items-center justify-center">
            <div
              class="flex h-24 w-24 items-center justify-center rounded-lg bg-primary-500 shadow-card "
            >
              <svg
      ...
      <p class="mt-8 text-sm text-gray-400 ">
        ...
        <a
          href="#"
          class="text-primary-600 transition-colors hover:text-primary-500  "
        >
          Contact support
        </a>
      </p>
