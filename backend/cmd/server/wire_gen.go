...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageInteractionRepository := repository.NewUsageInteractionRepository(db)
	usageInteractionService := service.NewUsageInteractionService(usageInteractionRepository, settingRepository)
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, turnstileService, opsService, paymentConfigService, paymentService, userAttributeService, notificationEmailService, totpService, userService, usageInteractionService)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator, usageInteractionService)
	...
	adminPermissionMiddleware := middleware.NewAdminPermissionMiddleware(adminPermissionRepository)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, adminPermissionMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, adminPermissionRepository, compositeRouteResolver, redisClient)
