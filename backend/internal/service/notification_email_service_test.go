...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "Nexus", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "Nexus", "https://example.com/reset", "en-US"))
