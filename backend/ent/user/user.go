...
const (
	...
	// EdgeAdminPermissions holds the string denoting the admin_permissions edge name in mutations.
	EdgeAdminPermissions = "admin_permissions"
	...
	// AdminPermissionsTable is the table that holds the admin_permissions relation/edge.
	AdminPermissionsTable = "admin_permissions"
	// AdminPermissionsInverseTable is the table name for the AdminPermission entity.
	// It exists in this package in order to avoid circular dependency with the "adminpermission" package.
	AdminPermissionsInverseTable = "admin_permissions"
	// AdminPermissionsColumn is the table column denoting the admin_permissions relation/edge.
	AdminPermissionsColumn = "user_id"
...
// ByAdminPermissionsCount orders the results by admin_permissions count.
func ByAdminPermissionsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newAdminPermissionsStep(), opts...)
	}
}

// ByAdminPermissions orders the results by admin_permissions terms.
func ByAdminPermissions(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newAdminPermissionsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newAdminPermissionsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(AdminPermissionsInverseTable, FieldID),
